      ...
      <div class="container">
          ...
          <div class="row">
              ...
              <div class="col-12 text-center my-5">
                  ...
                  <h1 class="display-3"><i class="fa fa-cogs text-primary" aria-hidden="true"></i> Lorem ipsum</h1>
          ...
          <div class="row mb-5">
                ...
                <nav id="navbarVertical" class="navbar navbar-light bg-light">
                    ...
                    <nav class="nav nav-pills flex-column">
                        ...
                        <nav class="nav nav-pills flex-column">
                            ...
                            <a class="nav-link ml-3" href="#item1-1">Nullam fringilla</a>
            ...
            <div class="col-sm-6 col-md-8">
                ...
                <div data-spy="scroll" data-target="#navbarVertical" data-offset="0" class="scrollspySite">
                    ...
                    <h5 id="item1-1">Quisque venenatis</h5>
                    ...
                    <h5 id="item1-2">Phasellus ullamcorpe</h5>
                    ...
                    <h5 id="item3-1">Quisque venenatis</h5>
                    <p>Morbi sollicitudin, leo rhoncus tempus mollis, magna magna auctor metus, sed mattis justo urna ultrices arcu. Pellentesque sed risus hendrerit, iaculis lectus et, sollicitudin nisi. Quisque faucibus facilisis malesuada. Donec maximus lorem vel eleifend bibendum. Sed efficitur, lectus a gravida ullamcorper, sem nibh placerat leo, sed facilisis erat mi vel mauris.</p>
                    
                    <h5 id="item3-2">Phasellus ullamcorpe</h5>
                    <p>Phasellus ullamcorper congue dui sed scelerisque. Praesent erat magna, tristique ac mauris ut, iaculis tincidunt velit. Aenean euismod facilisis ipsum, et auctor dui interdum sed. Suspendisse vitae arcu sit amet nulla hendrerit porta. Sed eget sodales eros. Donec auctor, nisl vel tincidunt auctor, est eros egestas odio, eget ultricies velit lorem nec eros. Praesent sed mauris sed urna scelerisque pulvinar. Vivamus non libero maximus, euismod tortor quis, tincidunt libero. Aliquam odio lectus, porttitor sed arcu a, porta faucibus odio. Nunc id lacinia ligula, sed venenatis mi.</p>
          ...
          <div class="row justify-content-sm-center">
              ...
              <div class="col-sm-6 col-md-4">
                  ...
                  <div class="card mb-5">
                      ...
                      <div class="card-body">
                        <h4 class="card-title">Duis dignissim</h4>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 text-center">
                        ...
                        <h1 class="display-4"><i class="fa fa-video-camera text-primary" aria-hidden="true"></i> Proin sed tellus</h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/IrjDAdUCy7w"></iframe>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <p>Morbi laoreet consequat nisl, in dapibus tellus dapibus sit amet. Pellentesque maximus ut lectus eu consectetur. Sed accumsan in libero non euismod. Vivamus commodo, mi et laoreet gravida, quam lectus cursus ante, a rhoncus quam ligula vel nunc. Duis dapibus velit vel risus tristique rhoncus.</p>
                        ...
                        <div class="tab-pane fade" id="nav-item-02" role="tabpanel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/r7ZgyFSsd-c"></iframe>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <p>Phasellus sed mauris volutpat, fringilla tellus porttitor, volutpat turpis. Pellentesque varius molestie libero vitae consectetur. Pellentesque eget eleifend elit, sed vulputate felis. Pellentesque eleifend eget nunc sit amet mattis. Quisque ornare, tortor ut euismod accumsan, tortor dui venenatis dolor, volutpat rhoncus lorem lorem non turpis.</p>
                        ...
                        <div class="tab-pane fade" id="nav-item-03" role="tabpanel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/nM1wS6x8DZM"></iframe>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <p>Curabitur porta erat semper lorem rutrum ornare. Sed lobortis dictum dui in condimentum. Donec nec purus malesuada diam elementum euismod in eu dolor. Maecenas ac ex ac massa feugiat suscipit. Maecenas egestas consequat neque, non commodo lectus rhoncus cursus. Suspendisse suscipit dignissim lorem. Sed porttitor leo et magna tempus, vel tempus urna consequat. Proin sed tellus ut sem blandit lacinia eu non arcu.</p>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <p>Donec semper maximus ipsum in feugiat. Sed blandit, magna nec maximus venenatis, nunc odio porttitor tellus, ac pulvinar mi velit vel erat. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Mauris sapien tellus, mattis nec tempus id, consequat non tortor. Nunc molestie orci purus, quis malesuada enim ullamcorper condimentum. Nullam vitae ultrices tortor. Pellentesque at felis eget nulla condimentum euismod. Nulla tortor nulla, suscipit at consectetur in, imperdiet eu tellus. Ut semper lorem orci, a malesuada ligula molestie non. Morbi lobortis erat eget ipsum iaculis, at sagittis est laoreet. Suspendisse pulvinar enim eu nunc cursus pharetra. Nam porttitor porttitor imperdiet. Duis gravida diam ultrices finibus interdum. Vestibulum at elementum eros. Proin in enim non lorem bibendum consectetur at vitae enim. Nam vel dolor ac velit pharetra pharetra.</p>
