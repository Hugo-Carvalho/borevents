<?php
    ...
    if((isset ($_SESSION['email']) == false) and (isset ($_SESSION['senha']) == false)) {
        ...
        header('location:perfil-user-s.php?b=' . $_GET['b']);
    }
    ...
    $_SESSION['cod_usuario_insc'] = $cod_usuario;

    $sql_exibir = "SELECT cod_tipo_fk, nome_usuario, img_usuario
                   FROM usuario 
    ...
    $sql_insc = "SELECT cod_inscricao
                   FROM inscricao 
                   WHERE MD5(organizador_inscricao) = '$cod_usuario' AND
                         cod_usuario_fk = '$id'";
    ...
    if($cod_tipo == 1){
        ...
        if ($row > 0) {
            ...
            $_SESSION['msg-insc'] = "&#9746; Cancelar inscrição";
        } else {
      ...
      <nav class="navbar navbar-fixed-top navbar-expand-lg navbar-dark bg-gradient-primary">
        ...
        <div id="main">
            <div class="container">
                ...
                <div class="name-org">
                    <label><?php echo $_SESSION['nome_usuario']; ?></label>
                </div>
                <div class="image">
                    <img class="img-circle img-thumbnail edit-image-perfil" src="<?php echo $_SESSION['img_usuario']; ?>">
                </div>
            </div>
            <div class="form-group col-xs-12">
                <div class="container">
                    <div class="d-none d-md-none d-lg-block">
                        <div class="menu-seg">
                            <a href="perfil-user-controller.php">
                ...
                <div class="feed">
                    <div class="container">
                        <?php
                            ...
                            $sql = "SELECT *
                                FROM evento
                                WHERE MD5(cod_usuario_fk) = '$cod_usuario'
