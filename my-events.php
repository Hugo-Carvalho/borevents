      ...
      <nav class="navbar navbar-fixed-top navbar-expand-lg navbar-dark bg-gradient-primary">
		...
		<div class="d-none d-md-block">
	        <div id="sidenav" class="sidenav">
				...
				<div class="search-my-events">
				    <form method="POST" action="result-search-my-events.php">
		                <input class="form-control" name="search-my-events" id="input-search-my-events" type="search" placeholder="Buscar seus eventos...">
		                <input class="btn btn-dark pointer" id="submit-search-my-events" type="submit" value="Bora"></input>
		            </form>
		        </div>
			</div>
		</div>
		<div class="d-block d-md-none">
	        <div id="sidenav-sm" class="sidenav-sm">
				...
				<div class="search-my-events-sm">
				    <form method="POST" action="result-search-my-events.php">
		                <input class="form-control" name="search-my-events" id="input-search-my-events" type="search" placeholder="Buscar meus eventos...">
		                <input class="btn btn-dark pointer" id="submit-search-my-events" type="submit" value="Bora"></input>
		            </form>
		        </div>
			</div>
	        		...
	        		<div class="d-none d-md-none d-lg-block">
				        <div class="menu-seg">
				          	<a href="new-event.php">
							    <span class="pointer">&#10010; Novo evento</span>
				          	</a>
							<div class="buscar-btn">
						    	<span class="pointer" onclick="open_nav_push()">&#9776; Buscar meus eventos</span>
						    </div>
						</div>
					</div>
					...
					<div class="d-block d-md-none d-lg-none">
						<div class="menu-seg-sm">
							...
							<div class="buscar-btn-sm">
						    	<span class="pointer" onclick="open_nav()">&#9776; Buscar meus eventos</span>
						    </div>
						</div>
					</div>
				</div>
